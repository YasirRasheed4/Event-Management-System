...
define('DB_HOST', defined('EMS_DB_HOST') ? EMS_DB_HOST : (getenv('EMS_DB_HOST') ?: 'localhost'));
define('DB_NAME', defined('EMS_DB_NAME') ? EMS_DB_NAME : (getenv('EMS_DB_NAME') ?: 'eventsphere'));
define('DB_USER', defined('EMS_DB_USER') ? EMS_DB_USER : (getenv('EMS_DB_USER') ?: ''));
